<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hosteldata.aspx.cs" Inherits="hosteldata" EnableEventValidation="False" %>
                                                    ...
                                                    <div class="ibox-content" style="border-style: none">
                                                        <div class="form-horizontal">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:Label ID="lblhostel" runat="server" CssClass="col-sm-4 control-label" Text="Hostel Name"></asp:Label>
                                                                <div class="col-sm-5">
                                                                    <asp:TextBox ID="txtHostelId" runat="server" CssClass="form-control" placeholder="Enter Hostel Name"></asp:TextBox>

                                                                    <asp:RequiredFieldValidator ID="rfvcity" runat="server" ControlToValidate="txtHostelId" ValidationGroup="A" ErrorMessage="Hostel Id is required" CssClass="text-danger"></asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <asp:GridView ID="GridViewCities" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover dataTables-example">
                                                                        <Columns>
                                                                            ...
                                                                            <asp:TemplateField HeaderText="Action">
                                                                                <ItemTemplate>
                                                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btn btn-primary btn-xs" OnClick="btnEdit_Click" CommandArgument='<%# Eval("HostelName") %>' />
                                                                                    <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="btn btn-danger btn-xs" OnClick="btndeleted_click" CommandArgument='<%# Eval("hostelId") %>' />
                                                                                </ItemTemplate>
                                                                            </asp:TemplateField>
                                                                        </Columns>
                                                                    </asp:GridView>
